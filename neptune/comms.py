"""
Based on
https://github.com/jupyter/qtconsole/blob/8e6be35ec0e561678de3abdcda565f443ad61ce1/qtconsole/comms.py
...
class CommManager(MetaQObjectHasTraits(
    ...
    def init_kernel_client(self, kernel_client):
        ...
        # kernel_client.iopub_channel.msg_ready.connect(self._dispatch)
